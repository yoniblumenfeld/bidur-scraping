...
from scrapers.cameri.cameri_response_parser import CameriResponseParser


class CameriScraper(GenericBidurScraper):
    def __int__(self, search_url, search_keywords_list=None):
    ...
    def parse_response(self, response):
        parser = CameriResponseParser(response, self.base_url)
